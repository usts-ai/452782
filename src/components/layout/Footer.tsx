      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="mt-3 sm:mt-0 flex items-center space-x-4">
            <a
              href="https://twitter.com/formagenie"
              target="_blank"
            ...
            <a
              href="https://github.com/formagenie"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://linkedin.com/company/formagenie"
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div className="mt-4 text-center text-xs text-gray-400">
          <p>FormaGenie est une plateforme de gestion de formations assistée par intelligence artificielle</p>
